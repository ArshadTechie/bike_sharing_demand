...
regressor = joblib.load(r"C:\Users\arsha\OneDrive\Desktop\bike_sharing_predication_final\xgboost_regressor.pkl")
...
# Streamlit code
st.set_page_config(page_title='Predicting Bike Demand', page_icon="🏍️")
...
Rainfall = st.number_input('Rainfall ⛈️', min_value=0.0, max_value=100.0, value=0.0, step=0.1)
